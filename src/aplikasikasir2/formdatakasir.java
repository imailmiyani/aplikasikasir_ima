...
public class formdatakasir extends javax.swing.JFrame {
    ...
    /**
     * Creates new form formdatakasir
     */
    ...
    try {
       String sql = "select * from aplikasikasirima";
  pst = konek.prepareStatement(sql);
  rst = pst.executeQuery();
  tbltambahdatakasir.setModel (DbUtils.resultSetToTableModel(rst));
    } catch ( Exception e)  {
...
private void clear() {
txtkodekasir.setText("");
txtnamakasir.setText("");
cmbjeniskelamin.setSelectedItem("-pilih salah satu-");
txtnohp.setText("");
}
     private void simpan() {
     try {
      String sql = "insert into aplikasikasirima(Kode_kasir,Nama_kasir,jeniskelamin,nohp)value(?,?,?,?,?)";
     pst = konek.prepareStatement(sql);
     pst.setString(1, txtkodekasir.getText());
     pst.setString(2, txtnamakasir.getText());
     pst.setString(3, (String)cmbjeniskelamin.getSelectedItem());
    ...
    private void initComponents() {
        ...
        tbltambahdatakasir = new javax.swing.JTable();
        ...
        cmbjeniskelamin.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "pilih salah satu" }));

        tbltambahdatakasir.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tbltambahdatakasir);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(cmbjeniskelamin, 0, 138, Short.MAX_VALUE)
                    .addComponent(txtnohp)
                    .addComponent(txtnamakasir)
                    .addComponent(txtkodekasir))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private javax.swing.JTable tbltambahdatakasir;
